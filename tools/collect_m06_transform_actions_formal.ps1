...
$logPath = Join-Path $repoRoot "output\verification\m06-transform-actions-formal-20260920.log"
Set-Location -LiteralPath $repoRoot
Start-Sleep -Seconds 5
foreach ($name in @(
    "M06-transform-dialogue-add-cold-start-01.json",
    "M06-transform-dialogue-clear-cold-start-01.json"
)) {
