...
$logPath = Join-Path $repoRoot "output\verification\m07-animation-pointers-discovery-20260920.log"
$fields = @("ally-animation-pointer", "enemy-animation-pointer")
Set-Location -LiteralPath $repoRoot
"M07 animation pointer discovery started: $(Get-Date -Format o)" | Set-Content $logPath
$failed = 0
...
"M07 animation pointer discovery finished: $(Get-Date -Format o); failed=$failed" | Add-Content $logPath
exit $failed
