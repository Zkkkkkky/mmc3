...
$config = Join-Path $repoRoot "tools\golden_pipeline\cases\M06-dialogue-attack-blocked-segment-cold-start-01.json"
$logPath = Join-Path $repoRoot "output\verification\m06-dialogue-segment-message-probe-20260920.log"
