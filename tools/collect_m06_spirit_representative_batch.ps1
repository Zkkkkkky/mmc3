...
$logPath = Join-Path $repoRoot "output\verification\m06-spirit-representative-formal-20260920.log"
$cases = @(
    "M06-spirit-02-cold-start-01.json",
    "M06-spirit-09-cold-start-01.json",
    "M06-spirit-17-cold-start-01.json",
    "M06-spirit-cost-02-cold-start-01.json",
    "M06-spirit-cost-09-cold-start-01.json",
    "M06-spirit-cost-17-cold-start-01.json"
)
Set-Location -LiteralPath $repoRoot
"M06 spirit representative formal batch started: $(Get-Date -Format o)" | Set-Content -LiteralPath $logPath -Encoding utf8
foreach ($name in $cases) {
    ...
    $stdout = Join-Path $repoRoot "output\verification\$tag-stdout-20260920.log"
    $stderr = Join-Path $repoRoot "output\verification\$tag-stderr-20260920.log"
    ...
    if (-not $finished) {
        ...
        "timeout" | Add-Content -LiteralPath $logPath -Encoding utf8
        continue
    }
...
"`nM06 spirit representative formal batch finished: $(Get-Date -Format o)" | Add-Content -LiteralPath $logPath -Encoding utf8
