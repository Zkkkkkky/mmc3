...
$config = Join-Path $repoRoot "tools\golden_pipeline\cases\M06-dialogue-special-attack-3-end-cold-start-01.json"
$logPath = Join-Path $repoRoot "output\verification\m06-special-dialogue-last-retry-20260920.log"
