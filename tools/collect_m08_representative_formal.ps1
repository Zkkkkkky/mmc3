...
$logPath = Join-Path $repoRoot "output\verification\m08-representative-formal-20260920.log"
$cases = @(
  "M08-battle-01-row000-variant000-cold-start-01.json",
  "M08-battle-04-row000-variant001-cold-start-01.json",
  "M08-battle-05-row001-variant000-cold-start-01.json",
  "M08-battle-07-alias-row000-variant000-cold-start-01.json"
)
Set-Location -LiteralPath $repoRoot
"M08 representative formal started: $(Get-Date -Format o)" | Set-Content $logPath
$failed=0
foreach($caseName in $cases){
  ...
  $stdout=Join-Path $repoRoot "output\verification\$safe-formal-stdout.log"
  $stderr=Join-Path $repoRoot "output\verification\$safe-formal-stderr.log"
...
"M08 representative formal finished: $(Get-Date -Format o); failed=$failed"|Add-Content $logPath
exit $failed
