...
$logPath = Join-Path $repoRoot "output\verification\m06-portrait-color-formal-20260920.log"
$cases = @(
    @{ Name = "M06-portrait-color-1-cold-start-01.json"; Field = "portrait_color_1" },
    @{ Name = "M06-portrait-color-2-cold-start-01.json"; Field = "portrait_color_2" },
    @{ Name = "M06-portrait-color-3-cold-start-01.json"; Field = "portrait_color_3" }
)
Set-Location -LiteralPath $repoRoot
"M06 portrait color formal batch started: $(Get-Date -Format o)" | Set-Content -LiteralPath $logPath -Encoding utf8
...
"`nM06 portrait color formal batch finished: $(Get-Date -Format o)" | Add-Content -LiteralPath $logPath -Encoding utf8
