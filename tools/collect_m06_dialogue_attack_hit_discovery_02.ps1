...
$config = Join-Path $repoRoot "tools\golden_pipeline\discovery_history\M06-dialogue-attack-hit-number-discovery-cold-start-02.json"
$logPath = Join-Path $repoRoot "output\verification\m06-dialogue-attack-hit-discovery-02-20260920.log"
$stdout = Join-Path $repoRoot "output\verification\m06-dialogue-attack-hit-discovery-02-stdout-20260920.log"
$stderr = Join-Path $repoRoot "output\verification\m06-dialogue-attack-hit-discovery-02-stderr-20260920.log"
