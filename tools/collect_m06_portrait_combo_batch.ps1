...
$logPath = Join-Path $repoRoot "output\verification\m06-portrait-combo-formal-20260920.log"
$cases = @(
    @{ Name = "M06-portrait-front-bank-cold-start-01.json"; Field = "portrait_front_bank" },
    @{ Name = "M06-portrait-front-slot-cold-start-01.json"; Field = "portrait_front_slot" },
    @{ Name = "M06-portrait-back-bank-cold-start-01.json"; Field = "portrait_back_bank" },
    @{ Name = "M06-portrait-back-slot-cold-start-01.json"; Field = "portrait_back_slot" }
)
Set-Location -LiteralPath $repoRoot
"M06 portrait combo formal batch started: $(Get-Date -Format o)" | Set-Content -LiteralPath $logPath -Encoding utf8
...
"`nM06 portrait combo formal batch finished: $(Get-Date -Format o)" | Add-Content -LiteralPath $logPath -Encoding utf8
