...
$config = Join-Path $repoRoot "tools\golden_pipeline\cases\M06-growth-curve-cold-start-01.json"
$logPath = Join-Path $repoRoot "output\verification\m06-growth-curve-formal-20260920.log"
Set-Location -LiteralPath $repoRoot
Start-Sleep -Seconds 20
$stdout = Join-Path $repoRoot "output\verification\m06-growth-curve-formal-stdout-20260920.log"
$stderr = Join-Path $repoRoot "output\verification\m06-growth-curve-formal-stderr-20260920.log"
