...
$logPath = Join-Path $repoRoot "output\verification\m06-special-dialogue-batch-20260920.log"
$configs = Get-ChildItem -LiteralPath (Join-Path $repoRoot "tools\golden_pipeline\cases") -Filter "M06-dialogue-special-attack-*-cold-start-01.json" | Sort-Object Name
Set-Location -LiteralPath $repoRoot
"M06 special dialogue batch: $($configs.Count) cases" | Set-Content -LiteralPath $logPath -Encoding utf8
