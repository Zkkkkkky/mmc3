...
$logPath = Join-Path $repoRoot "output\verification\m06-transform-dialogue-formal-20260920.log"
Set-Location -LiteralPath $repoRoot
Start-Sleep -Seconds 5
foreach ($name in @(
    "M06-transform-dialogue-start-cold-start-01.json",
    "M06-transform-dialogue-end-cold-start-01.json",
    "M06-transform-dialogue-number-cold-start-01.json"
)) {
