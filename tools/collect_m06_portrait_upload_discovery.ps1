...
$logPath = Join-Path $repoRoot "output\verification\m06-portrait-upload-discovery-20260920.log"
Set-Location -LiteralPath $repoRoot
Start-Sleep -Seconds 5
foreach ($name in @(
    "M06-portrait-front-upload-discovery-cold-start-01.json",
    "M06-portrait-back-upload-discovery-cold-start-01.json"
)) {
