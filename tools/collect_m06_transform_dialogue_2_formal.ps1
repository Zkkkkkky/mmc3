...
$logPath = Join-Path $repoRoot "output\verification\m06-transform-dialogue-2-formal-20260920.log"
Set-Location -LiteralPath $repoRoot
Start-Sleep -Seconds 5
foreach ($name in @(
    "M06-transform-dialogue-2-start-cold-start-01.json",
    "M06-transform-dialogue-2-end-cold-start-01.json",
    "M06-transform-dialogue-2-number-cold-start-01.json"
)) {
