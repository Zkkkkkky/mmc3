...
$logPath = Join-Path $repoRoot "output\verification\m06-transform-actions-discovery-02-20260920.log"
Set-Location -LiteralPath $repoRoot
Start-Sleep -Seconds 5
foreach ($name in @(
    "M06-transform-dialogue-add-discovery-cold-start-02.json",
    "M06-transform-dialogue-clear-discovery-cold-start-02.json"
)) {
