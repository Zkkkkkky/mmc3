...
$config = Join-Path $repoRoot "tools\golden_pipeline\discovery_history\M06-dialogue-attack-hit-number-discovery-cold-start-01.json"
$logPath = Join-Path $repoRoot "output\verification\m06-dialogue-attack-hit-discovery-20260920.log"
$stdout = Join-Path $repoRoot "output\verification\m06-dialogue-attack-hit-discovery-stdout-20260920.log"
$stderr = Join-Path $repoRoot "output\verification\m06-dialogue-attack-hit-discovery-stderr-20260920.log"
