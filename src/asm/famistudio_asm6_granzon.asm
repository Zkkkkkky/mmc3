...
.ifdef FAMISTUDIO_CFG_SCATTERED_BSS

.ifdef FAMISTUDIO_CFG_DC_COMPACT_BSS

; DC.nes compact layout.  Every persistent byte is inside the removed stock
; driver's proven $0400-$046F/$0028-$005D state.  $002C was not used by the
; stock driver and is intentionally left alone.  $004C-$0056 is reserved for
; a call-local APU output buffer and is saved/restored by the bridge.
.enum $0400
...
famistudio_song_speed = $002f

.if FAMISTUDIO_CFG_SFX_SUPPORT
famistudio_output_buf = $004c
.enum $0459
...
; DC.nes uses most internal RAM as state-dependent workspaces.  The dual-engine
; build keeps these groups at $031E-$037F and pauses/rebuilds FamiStudio during
; the one verified map-weapon particle state that borrows that range.  Other
; builds retain the experimental stack-page layout selected previously.
.ifdef FAMISTUDIO_CFG_DC_PARTICLE_BSS
.enum $031e
.else
.enum $0100
.endif
...
.enum $0429
famistudio_chn_return_hi:
    .dsb FAMISTUDIO_NUM_CHANNELS
famistudio_chn_ref_len:           .dsb FAMISTUDIO_NUM_CHANNELS
famistudio_pitch_env_repeat:      .dsb FAMISTUDIO_NUM_PITCH_ENVELOPES
famistudio_pitch_env_addr_lo:     .dsb FAMISTUDIO_NUM_PITCH_ENVELOPES
famistudio_chn_volume_track:      .dsb FAMISTUDIO_NUM_CHANNELS
...
famistudio_instrument_lo:         .dsb 1
famistudio_instrument_hi:         .dsb 1
famistudio_dpcm_list_lo:          .dsb 1
famistudio_dpcm_list_hi:          .dsb 1
famistudio_dpcm_effect:           .dsb 1
famistudio_pulse1_prev:           .dsb 1
famistudio_pulse2_prev:           .dsb 1
famistudio_song_speed:
    .dsb 1
.ende

.if FAMISTUDIO_CFG_SFX_SUPPORT
; Full-driver replacement frees the stock audio work area at $0400-$046F.
; A single FamiStudio SFX stream needs 28 contiguous bytes.
.enum $0400
...
famistudio_r2   = $002a
famistudio_r3   = $002b
famistudio_ptr0 = $002d
famistudio_ptr1 = $0030
.else
...
.ifndef FAMISTUDIO_CFG_DC_FIXED_MUSIC_BASE
...
.else
    ...
    .endif
.endif
.ifndef FAMISTUDIO_CFG_DC_COMPACT_BSS
...
.ifdef FAMISTUDIO_CFG_DC_FIXED_MUSIC_BASE
    ldx #<$8000
    stx song_list_ptr+0
    ldx #>$8000
    stx song_list_ptr+1
...
.ifndef FAMISTUDIO_CFG_DC_FIXED_SFX_TABLE
...
.ifdef FAMISTUDIO_CFG_DC_FIXED_SFX_TABLE
    lda #<dc_sfx_table
...
famistudio_note_table_lsb:
        .if FAMISTUDIO_CFG_PAL_SUPPORT
            .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_note_table_pal_lsb.bin"
        .endif
        .if FAMISTUDIO_CFG_NTSC_SUPPORT
            .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_note_table_lsb.bin"
        .endif
...
famistudio_note_table_msb:
        .if FAMISTUDIO_CFG_PAL_SUPPORT
            .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_note_table_pal_msb.bin"
        .endif
        .if FAMISTUDIO_CFG_NTSC_SUPPORT
            .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_note_table_msb.bin"
        .endif
    ...
    famistudio_saw_note_table_lsb:
        .if FAMISTUDIO_CFG_PAL_SUPPORT
            .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_saw_note_table_pal_lsb.bin"
        .endif
        .if FAMISTUDIO_CFG_NTSC_SUPPORT
            .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_saw_note_table_lsb.bin"
        .endif
    famistudio_exp_note_table_msb:
    famistudio_saw_note_table_msb: 
        .if FAMISTUDIO_CFG_PAL_SUPPORT  
            .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_saw_note_table_pal_msb.bin"
        .endif
        .if FAMISTUDIO_CFG_NTSC_SUPPORT    
            .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_saw_note_table_msb.bin"
        .endif
    .endif
    ...
    famistudio_vrc7_note_table_lsb:
        .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_vrc7_note_table_lsb.bin"
    famistudio_exp_note_table_msb:
    famistudio_vrc7_note_table_msb:
        .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_vrc7_note_table_msb.bin"
    .endif

    .if FAMISTUDIO_EXP_EPSM
        .if FAMISTUDIO_EXP_EPSM_FM_CHN_CNT > 0
    famistudio_epsm_note_table_lsb:
        .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_epsm_note_table_lsb.bin"
    famistudio_epsm_note_table_msb:
        .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_epsm_note_table_msb.bin"
        .endif
    famistudio_exp_note_table_lsb:
    famistudio_epsm_s_note_table_lsb:
        .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_epsm_s_note_table_lsb.bin"
    famistudio_exp_note_table_msb:
    famistudio_epsm_s_note_table_msb:
        .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_epsm_s_note_table_msb.bin"
    .endif
    ...
    famistudio_fds_note_table_lsb:
        .if FAMISTUDIO_CFG_PAL_SUPPORT
            .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_fds_note_table_pal_lsb.bin"
        .endif
        .if FAMISTUDIO_CFG_NTSC_SUPPORT
            .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_fds_note_table_lsb.bin"
        .endif
    famistudio_exp_note_table_msb:
    famistudio_fds_note_table_msb:
        .if FAMISTUDIO_CFG_PAL_SUPPORT
            .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_fds_note_table_pal_msb.bin"
        .endif
        .if FAMISTUDIO_CFG_NTSC_SUPPORT
            .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_fds_note_table_msb.bin"
        .endif
    .endif
    ...
    famistudio_n163_note_table_lsb:
        .if FAMISTUDIO_CFG_PAL_SUPPORT
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 1
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_pal_1ch_lsb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 2
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_pal_2ch_lsb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 3
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_pal_3ch_lsb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 4
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_pal_4ch_lsb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 5
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_pal_5ch_lsb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 6
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_pal_6ch_lsb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 7
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_pal_7ch_lsb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 8
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_pal_8ch_lsb.bin"
            .endif
        .endif
        .if FAMISTUDIO_CFG_NTSC_SUPPORT
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 1
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_1ch_lsb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 2
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_2ch_lsb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 3
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_3ch_lsb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 4
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_4ch_lsb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 5
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_5ch_lsb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 6
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_6ch_lsb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 7
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_7ch_lsb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 8
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_8ch_lsb.bin"
            .endif
        .endif
    famistudio_exp_note_table_msb:
    famistudio_n163_note_table_msb:
        .if FAMISTUDIO_CFG_PAL_SUPPORT
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 1
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_pal_1ch_msb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 2
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_pal_2ch_msb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 3
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_pal_3ch_msb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 4
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_pal_4ch_msb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 5
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_pal_5ch_msb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 6
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_pal_6ch_msb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 7
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_pal_7ch_msb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 8
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_pal_8ch_msb.bin"
            .endif
        .endif
        .if FAMISTUDIO_CFG_NTSC_SUPPORT
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 1
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_1ch_msb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 2
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_2ch_msb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 3
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_3ch_msb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 4
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_4ch_msb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 5
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_5ch_msb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 6
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_6ch_msb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 7
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_7ch_msb.bin"
            .endif
            .if FAMISTUDIO_EXP_N163_CHN_CNT = 8
                .incbin "../../tools/vendor/famistudio-4.5.3/SoundEngine/NoteTables/famistudio_n163_note_table_8ch_msb.bin"
            .endif
        .endif
    .endif
