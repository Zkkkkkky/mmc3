...
$asm6 = Join-Path $root "analysis\FamiStudio-4.5.3-source\FamiStudio-4.5.3\Tools\asm6_fixed.exe"
$specFile = Join-Path $root "dc_modifier.spec"
$dist = Join-Path $root "FC模拟器"
