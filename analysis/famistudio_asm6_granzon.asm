...
famistudio_note_table_lsb:
        .if FAMISTUDIO_CFG_PAL_SUPPORT
            .incbin "FamiStudio-4.5.3-source/FamiStudio-4.5.3/SoundEngine/NoteTables/famistudio_note_table_pal_lsb.bin"
        .endif
        .if FAMISTUDIO_CFG_NTSC_SUPPORT
            .incbin "FamiStudio-4.5.3-source/FamiStudio-4.5.3/SoundEngine/NoteTables/famistudio_note_table_lsb.bin"
        .endif
...
famistudio_note_table_msb:
        .if FAMISTUDIO_CFG_PAL_SUPPORT
            .incbin "FamiStudio-4.5.3-source/FamiStudio-4.5.3/SoundEngine/NoteTables/famistudio_note_table_pal_msb.bin"
        .endif
        .if FAMISTUDIO_CFG_NTSC_SUPPORT
            .incbin "FamiStudio-4.5.3-source/FamiStudio-4.5.3/SoundEngine/NoteTables/famistudio_note_table_msb.bin"
        .endif
