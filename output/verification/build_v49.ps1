...
$target = 'C:\Users\hu\Desktop\测试_敌方武器跨UI_R1复合CHR修复V49.nes'
$reference = 'D:\GIT\mmc3\output\verification\v49-rebuilt-from-test.nes'
...
# 先更新镜像和 IRQ 两行，再立即写 MMC3 R1，保证当前帧顶部已使用复合页。
$setupMirrors=[byte[]](
...
$setupMapper=[byte[]](
    0xA9,0x81,0x8D,0x00,0x80,
    0xA9,0x30,0x8D,0x01,0x80,
    0x4C,0x65,0xFF
)
