local out=[[D:\GIT\mmc3\output\verification\v12-purple-]]
local log=assert(io.open([[D:\GIT\mmc3\output\verification\v12-purple-trace.tsv]],"w"))
...
for frame=1,10000 do
  ...
  if frame>=2250 and frame<=9400 and frame%90==0 then joypad.set(1,{A=true}) end
  if frame>=3800 then
    local crossing=0
