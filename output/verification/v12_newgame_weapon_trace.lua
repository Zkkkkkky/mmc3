local out=[[D:\GIT\mmc3\output\verification\v12-weapon-]]
local log=assert(io.open([[D:\GIT\mmc3\output\verification\v12-weapon-trace.tsv]],"w"))
...
for frame=1,4300 do
  ...
  if frame>=2250 and frame<=4050 and frame%90==0 then joypad.set(1,{A=true}) end
  if frame>=2150 then
    local crossing=0
