local out=[[D:\GIT\mmc3\output\verification\v12-emptymenu-]]
...
for frame=1,2100 do
  ...
  if frame==1580 or frame==1640 or frame==1700 or frame==1850 or frame==2100 then gui.savescreenshotas(out..frame..[[.png]]) end
  emu.frameadvance()
end
emu.exit()
