local out=[[D:\GIT\mmc3\output\verification\v12-fullattack-]]
...
for frame=1,5000 do
  ...
  if frame==1750 or frame==1755 then joypad.set(1,{A=true}) end
  if frame>=1700 and frame%5==0 then gui.savescreenshotas(out..frame..[[.png]]) end
  emu.frameadvance()
end
emu.exit()
